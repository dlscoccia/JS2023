...
const fetch_adapter_1 = require("../common/adapters/fetch.adapter");
let SeedService = class SeedService {
    ...
    async execute() {
        ...
        const data = await this.http.get('https://pokeapi.co/api/v2/pokemon?limit=20');
