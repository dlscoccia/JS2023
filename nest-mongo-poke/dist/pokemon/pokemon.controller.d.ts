...
export declare class PokemonController {
    ...
    findAll(paginationDto: PaginationDto): import("mongoose").Query<(import("mongoose").Document<unknown, {}, import("./entities/pokemon.entity").Pokemon> & Omit<import("./entities/pokemon.entity").Pokemon & {
        ...
        _id: import("mongoose").Types.ObjectId;
    }, never>, {}, import("./entities/pokemon.entity").Pokemon, "find">;
    findOne(query: string): Promise<import("./entities/pokemon.entity").Pokemon>;
    update(query: string, updatePokemonDto: UpdatePokemonDto): Promise<{
        idx?: number;
        name?: string;
    }>;
